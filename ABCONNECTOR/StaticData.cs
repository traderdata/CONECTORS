...
namespace Traderdata.Client.ABConnector
{
    public static class StaticData
    {
        ...
        /// Endpoints
        /// </summary>
        public static string SECURITY_ENDPOINT = "";
        public static string MARKETDATA_ENDPOINT = "";
        public static string MARKETDATA_RT = "";
        public static string SECURITY_TOKEN = "td001";
