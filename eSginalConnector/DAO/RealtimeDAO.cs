...
namespace Traderdata.Client.eSginalConnector.DAO
{
    public static class RealTimeDAO
    {
        ...
        /// </summary>
        private static List<string> listTickSubscription = new List<string>();

        /// <summary>
        /// Lista de assinaturas de trades
        /// </summary>
        private static List<string> listTradeSubscription = new List<string>();
        ...
        public static void ConnectTelnetServer()
        {
            ...
            StaticData.RealtimeTelnet.IniciaConexao("feeder-br.traderdata.com.br", 3002);
